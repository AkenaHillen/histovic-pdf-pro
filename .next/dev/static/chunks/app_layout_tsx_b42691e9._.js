        ...
        try {
            ...
            if (mode === 'merge') {
                for (const file of files){
                    ...
                    const srcDoc = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdf$2d$lib$2f$es$2f$api$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PDFDocument"].load(buffer);
...
_s(PdfApp, "kZoZ00uhEgQ222NkjngCM/+QN9A=");
_c = PdfApp;
// STYLES
...
var _c;
__turbopack_context__.k.register(_c, "PdfApp");
