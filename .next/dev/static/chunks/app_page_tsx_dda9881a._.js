    ...
    const processPDF = async ()=>{
        ...
        try {
            if (mode === 'image' || mode === 'text') {
                ...
                const src = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdf$2d$lib$2f$es$2f$api$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PDFDocument"].load(await files[0].arrayBuffer());
                if (mode === 'merge') {
...
_s(HistovicPdfPro, "vmtlalxkL8yJdUy7ra6n0e4WUgE=");
_c = HistovicPdfPro;
